        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              data: {
                // data send with request(gửi lên url)
                email: email,
                password: password
              }
            });
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context2.t0.response.data.message); //console.log(err.response.data.message)
...
if (userDataForm) {
  ...
  userDataForm.addEventListener('submit', function (e) {
    ...
    form.append('photo', document.getElementById('photo').files[0]); // for(var p of form){
    //     console.log(p);
    // }
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              //khi bấm save password sẽ lọt vào addEventListener
              e.preventDefault();
            ...
            case 7:
              //await vì updateSetting là async function
